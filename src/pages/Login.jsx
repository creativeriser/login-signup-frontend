  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok && data.token) {
        ...
        setError(data.msg || data || 'Login failed');
      }
    } catch (err) {
        ...
        <div className="flex h-full w-full flex-col px-6 md:px-16 lg:w-1/2 xl:px-24">
          ...
          >
            ...
            <p className="mt-5 text-center text-sm text-ink-600">
              ...
              <Link to="/register" className="font-medium text-brand-600 hover:text-brand-700 hover:underline outline-none focus-visible:ring-2 focus-visible:ring-brand-500 focus-visible:ring-offset-2 rounded disabled:opacity-50 disabled:pointer-events-none">
                Create one
              </Link>
            </p>
          </motion.div>
